	...
	geolocalisations := []models.Geolocalisation{
		{
			...
			DateEnregistrement: time.Now().Add(-time.Hour * 24 * 30),
			MethodeCapture:     "gps",
			FiabiliteSource:    "elevee",
			Actif:              true,
		...
		},
		{
			...
			Ville:              "Kinshasa",
			Pays:               "République Démocratique du Congo",
			DateEnregistrement: time.Now().Add(-time.Hour * 24 * 45),
			MethodeCapture:     "automatique",
			FiabiliteSource:    "elevee",
			Actif:              true,
		...
		// === GÉOLOCALISATIONS POUR DÉPLACÉS INTERNES RDC ===
		{
			...
			Ville:              "Goma",
			Pays:               "République Démocratique du Congo",
			DateEnregistrement: time.Now().Add(-time.Hour * 24 * 120),
			MethodeCapture:     "manuel",
			FiabiliteSource:    "elevee",
			Actif:              true,
			TypeMouvement:      "residence_temporaire",
			CreatedAt:          time.Now(),
		...
		},
		{
			...
			Ville:              "Rutshuru",
			Pays:               "République Démocratique du Congo",
			DateEnregistrement: time.Now().Add(-time.Hour * 24 * 130),
			MethodeCapture:     "manuel",
			FiabiliteSource:    "moyenne",
			Actif:              false,
		...
		},
		{
			...
			Ville:              "Kinshasa",
			Pays:               "République Démocratique du Congo",
			DateEnregistrement: time.Now().Add(-time.Hour * 24 * 25),
			MethodeCapture:     "gps",
			FiabiliteSource:    "elevee",
			Actif:              true,
			TypeMouvement:      "residence_temporaire",
		...
		},
		{
			...
			Ville:              "Bunia",
			Pays:               "République Démocratique du Congo",
			DateEnregistrement: time.Now().Add(-time.Hour * 24 * 90),
			MethodeCapture:     "manuel",
			FiabiliteSource:    "elevee",
			Actif:              true,
			TypeMouvement:      "residence_temporaire",
		...
		},
		{
			...
			Ville:              "Kinshasa",
			Pays:               "République Démocratique du Congo",
			DateEnregistrement: time.Now().Add(-time.Hour * 24 * 80),
			MethodeCapture:     "manuel",
			FiabiliteSource:    "elevee",
			Actif:              true,
			TypeMouvement:      "residence_temporaire",
...
func simulateBiometries(db *gorm.DB) error {
	...
	for i, migrant := range migrants {
		...
		bio.DateExpiration = &[]time.Time{time.Now().Add(time.Hour * 24 * 365 * 5)}[0]
		...
		bio2.DateExpiration = &[]time.Time{time.Now().Add(time.Hour * 24 * 365 * 5)}[0]
	...
	alerts := []models.Alert{
		{
			...
			NotifierAutorités:   true,
			Latitude:            &[]float64{-4.3317}[0],
			Longitude:           &[]float64{15.3139}[0],
		...
		},
		{
			...
			NotifierAutorités:   false,
			Latitude:            &[]float64{-4.3728}[0],
			Longitude:           &[]float64{15.2663}[0],
			Adresse:             "Centre CARITAS, Boulevard Triomphal, Kinshasa",
		...
		},
		{
			...
			NotifierAutorités:   false,
			Latitude:            &[]float64{-4.3286}[0],
			Longitude:           &[]float64{15.3225}[0],
			Adresse:             "Quartier Matonge, Rue 12, Kinshasa",
		...
		// Alertes spécifiques pour les déplacés internes de la RDC
		{
			...
			NotifierAutorités:   true,
			Latitude:            &[]float64{-1.6792}[0],
			Longitude:           &[]float64{29.2450}[0],
			Adresse:             "Camp de Mugunga, Goma, Nord-Kivu",
		...
		},
		{
			...
			Latitude:            &[]float64{-4.3317}[0],
			Longitude:           &[]float64{15.3139}[0],
			Adresse:             "Centre d'accueil de Kinshasa",
		...
		},
		{
			...
			NotifierAutorités:   false,
			Latitude:            &[]float64{1.6596}[0],
			Longitude:           &[]float64{30.1944}[0],
			Adresse:             "Camp de Rhoe, Bunia, Ituri",
		...
		},
		{
			...
			Latitude:            &[]float64{-4.3317}[0],
			Longitude:           &[]float64{15.3139}[0],
			Adresse:             "Bureau d'état civil, Kinshasa",
